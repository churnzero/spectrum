...
QUnit.test ("addInitialToSelectionPalette", function(assert) {
  ...
  assert.ok(selectedColor.length > 0, "Initial color is shown in the selection palette.");
  ...
  assert.ok(selectedColor.length === 0, "Initial color is not shown in the selection palette.");
